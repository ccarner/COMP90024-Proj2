...
export function getSuburbAurinArray(){
    const melb_aurin = require('../data/AURIN/melbourne_aurin.json');
    const adelaide_aurin = require('../data/AURIN/adelaide_aurin.json');
    const perth_aurin = require('')
}
